...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["institution_id"],
            ["account-connections.institutions.institution_id"],
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.user_id"],
    ...
    op.create_index(
        op.f("ix_account-connections_institution_connections_institution_id"),
        "institution_connections",
        ["institution_id"],
        unique=False,
        schema="account-connections",
    ...
    op.create_index(
        op.f("ix_account-connections_institution_connections_user_id"),
        "institution_connections",
        ["user_id"],
        unique=False,
        schema="account-connections",
